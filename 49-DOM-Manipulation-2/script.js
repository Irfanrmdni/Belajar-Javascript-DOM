...
// membuat paragraf p dan menyimpan nya ke html
const paragrafBaru = document.createElement('p');
const isiParagrafBaru = document.createTextNode('paragraf baru');
paragrafBaru.appendChild(isiParagrafBaru);

const secA = document.getElementById('a');
secA.appendChild(paragrafBaru);

// membuat li baru dan menyimpan nya ke html
const liBaru = document.createElement('li');
const isiLiBaru = document.createTextNode('item baru');
liBaru.appendChild(isiLiBaru);
...
// style
paragrafBaru.style.backgroundColor = ('salmon');
